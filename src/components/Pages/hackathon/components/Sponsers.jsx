        ...
        <div className={styles.sponser}>
          ...
          >
            <g filter="url(#filter0_f_41_84)">
              <path
                d="M4 24C4 12.9543 12.9543 4 24 4H131C142.046 4 151 12.9543 151 24V425C151 436.046 142.046 445 131 445H24C12.9543 445 4 436.046 4 425V24Z"
                fill="#FDFAB5"
                fill-opacity="0.1"
              />
            </g>
            <defs>
              ...
              >
                ...
                <feGaussianBlur
                  stdDeviation="2"
                  result="effect1_foregroundBlur_41_84"
                />
              </filter>
            </defs>
          </svg>
